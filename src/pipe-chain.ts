 ...
 */
export function pipeMessageStream(
  readable: ReadableStream<StreamMessage>,
 ...
 */
export function transformMessageStream(
  readable: ReadableStream<StreamMessage>,
  transform: TransformStream<StreamMessage, StreamMessage>,
  options?: StreamPipeOptions
 ...
 */
export function transformMessageStreamTo<T>(
  readable: ReadableStream<StreamMessage>,
  transform: TransformStream<StreamMessage, T>,
  options?: StreamPipeOptions
): ReadableStream<T> {
  return readable.pipeThrough(transform, options);
}
 ...
 */
export function teeMessageStream(
  readable: ReadableStream<StreamMessage>
): [ReadableStream<StreamMessage>, ReadableStream<StreamMessage>] {
  return readable.tee() as [ReadableStream<StreamMessage>, ReadableStream<StreamMessage>];
}
...
export function composeTransforms(
  readable: ReadableStream<StreamMessage>,
  transforms: TransformStream<StreamMessage, StreamMessage>[]
): ReadableStream<StreamMessage> {

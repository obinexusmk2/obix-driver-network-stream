 ...
 * });
 */
export function createByteReadableStream(config = {}) {
 ...
 */
export async function readExactBytes(stream, length) {
 ...
 */
export async function concatByteStream(stream) {
    const chunks = [];
...
//# sourceMappingURL=byte-stream.js.map